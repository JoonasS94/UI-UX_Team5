...
public class CraneJoystick : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (forwardBackwardTilt < 355 && forwardBackwardTilt > 290)
        {
            ...
            ship.transform.Translate(new Vector3(-1, 0, 0) * rotatespeed * Time.deltaTime);
        }
        ...
        if (sideToSideTilt < 355 && sideToSideTilt > 290)
        {
            ...
            ship.transform.Translate(new Vector3(0, 0, -1) * rotatespeed * Time.deltaTime);
        }
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            transform.LookAt(other.transform.position, transform.up * -1f);
        }
    }
}
